...
\begin{description}
    ...
    \begin{itemize}
        \item 1行目はヘッダー行とする。
        \item 2行目以降に各要求仕様を1行ずつ記述する。
        \item 列は、要求仕様記述項目(表\ref{tb:reqspec_item}参照)の順序で記述する。
    \end{itemize}
\end{description}
...
\begin{description}
    ...
    \begin{itemize}
        \item 1行目はヘッダー行とする。
        \item 2行目以降に各テストケースを1行ずつ記述する。
        \item 列は、テストケース記述項目(表\ref{tb:testcase_item}参照)の順序で記述する。
    \end{itemize}
\end{description}
