...
以降、要求仕様テンプレートに基づいて記述した要求仕様の内容を、要求仕様文とする。
...
\tool は、以下の8つの条件をすべて満たすテストスイートを入力対象とする。
...
本研究で用いる、要求仕様とテストケースの対応関係に関する5つの用語を、以下に示す。
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item テストケースの不備\\
        ある要求仕様をテストするテストケースは存在するが、内容が要求仕様に対して不十分な状態を、テストケースの不備と呼ぶ。
        \item テストケースの過剰\\
